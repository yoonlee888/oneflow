...
class TestTensorDataset(oneflow.unittest.TestCase):
        ...
        for epoch in range(1, num_epochs + 1):
            ...
            # for i in range(num_examples // batch_size):
                ...
                if i % print_interval == 0:
                    print("epoch: %d  step: %5d  loss: %.3f " % (epoch, i, l.detach().cpu().numpy()))


if __name__ == "__main__":
    unittest.main()
    # 1 epoch training log(torch 1.9.0)
    # speed test 
    # batch_size 128   >>   23.4 24.1 21.6

    # speed test without dataloader
    # batch_size 128   >>   15.3 15.2 17.0
